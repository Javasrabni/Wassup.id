                ...
                <div key={i.id} className="flex gap-4 cursor-pointer">
                    ...
                    <div>
                        ...
                        <div className="pt-4 w-fit flex flex-row gap-4 items-center">
                            <Link href={`/read/${i.category.toLowerCase()}/${i.slug}`}><p className="bg-gray-900 hover:bg-gray-200 text-white hover:text-gray-900 px-3 py-2 text-[10px] uppercase tracking-widest">Baca selengkapnya</p></Link>
