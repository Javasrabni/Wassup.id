...
const Footer = () => {
  ...
  return (
    <div className="max-w-[60rem] w-full m-auto h-full  py-8 px-8 gap-8 flex flex-col border-t border-gray-200 ">
      <div className="w-full h-full gap-16 flex flex-col sm:flex-row items-center justify-between">
        {/* Brand */}
        <div className="hidden lg:flex shrink-1 md:shrink-0 flex flex-col gap-4 w-72 h-full">
